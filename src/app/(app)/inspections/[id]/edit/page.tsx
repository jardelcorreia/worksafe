...
import { fetchInspectionById, updateInspection, fetchAuditors, fetchAreas, fetchRiskTypes } from '@/lib/actions';
import { useToast } from '@/hooks/use-toast';
import { PotentialLevels, StatusLevels, inspectionSchema, type Auditor, type Area, type RiskType, type SafetyInspection } from '@/lib/types';
...
export default function EditInspectionPage({ params }: { params: { id: string } }) {
  ...
  if (isLoading || !inspection) {
    return (
        <Card>
            <CardHeader>
                <CardTitle>Editar Inspeção de Segurança</CardTitle>
            </CardHeader>
            <CardContent>
